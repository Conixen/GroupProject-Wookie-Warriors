...
=======
        ...
        List<(string UserName, string Password)> users = new List<(string, string)> { ("Simon", "Wakanda"), ("Tim", "Ironman"), ("Filip", "Superman"), ("Shokran", "Batman"), ("Leon", "Joker") };
        ...
        // Meny log in as admin
        // Many log in as user
        // Logg in for Admin
        // Logg on for normal user
